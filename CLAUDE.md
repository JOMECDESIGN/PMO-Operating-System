...
| Two-site software-hardware dev flow (S2) | `docs/dev-flow.md` | The end-to-end Hangzhou↔Kunshan dev process — phases, parallel lines, three gates (G1/G2/G3); weeks are per-project |
